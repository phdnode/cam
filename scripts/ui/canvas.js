...
let canvas = fastn('div',{class:'container'},
  fastn('canvas',{width: window.innerWidth, height: window.innerHeight})
  // ,
  // controls
)
...
//   var wobble = 0;// Math.sin(Date.now()/250)*window.innerHeight/50;
//
//   // draw the cube
//   drawCube(
//     window.innerWidth/2,
